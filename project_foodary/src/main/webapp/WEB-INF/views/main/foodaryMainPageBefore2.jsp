...
<body>
	...
	<header id="header" class="alt">
		<div class="inner">
			<a href="?" style="
				font-family: 'insungitCutelivelyjisu'; font-size: 100pt; font-weight: 900;
				color: black; cursor: pointer; text-decoration: none;">
				Foodary
			</a>
			<p class="text-center">
				<span style="background: #fafcd9; font-size: 26pt; color: black; font-weight: 900;">"내 몸을 위한 일기장"</span>
			</p>
					<button type="button" onclick="location.href='register/register'" style="background: none; border: 0; cursor: pointer;">
	        	 		<span style="background: lavender; color:black; font-size: 28pt;">회원가입</span>
	        	 	</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" onclick="location.href='main/mainLoginForm'" style="background: none; border: 0; cursor: pointer;">
...
<div id="calculator" class="alt" align="center" style="display: flex; text-align: center; ">
		<table width="600px" style="margin-left: 20%; margin-right: 20%" border="0" cellspacing="5px" cellpadding="10px">
			...
			<tr>
				...
				<span
					style="background: lavender; font-size: 22pt;">현재 체중:</span><input
					type="text" id="currentWeight"
					style="width: 70px; height: 25px; font-size: 25pt; border-left: 0; border-right: 0; border-top: 0; border-bottom: 5; text-align: center;" />
					kg</th>
			</tr>
			<tr>
				<th style="text-align: center; font-size: 22pt;"><span
					style="background: lavender; font-size: 22pt;">목표 체중:</span> <input
					type="text" id="goalWeight"
					style="width: 70px; height: 25px; font-size: 25pt; border-left: 0; border-right: 0; border-top: 0; border-bottom: 5; text-align: center;" />
					kg</th>
			</tr>
			<tr>
				<th style="text-align: center; font-size: 22pt;"><span
					style="background: lavender; font-size: 22pt;">키:</span> <input
					type="text" id="height"
					style="width: 70px; height: 25px; font-size: 25pt; border-left: 0; border-right: 0; border-top: 0; border-bottom: 5; text-align: center;" />
					cm</th>
			</tr>
			<tr>
				<th style="text-align: center; font-size: 22pt;"><span
					style="background: lavender; font-size: 22pt;">만 나이:</span> <input
					type="text" id="age"
					style="width: 70px; height: 25px; border-left: 0; border-right: 0; border-top: 0; border-bottom: 5; text-align: center;" />
					세</th>
			</tr>
			<tr>
				<th style="text-align: center; font-size: 22pt;"><span
					style="background: lavender; font-size: 22pt;">성별:</span>&nbsp;
					<input id="gender" type="radio" name="gender" checked="checked"
					value="남성" />&nbsp;남성 &nbsp; <input id="gender" type="radio"
					name="gender" value="여성" />여성</th>
			</tr>
			<tr>
				<th style="text-align: center; font-size: 22pt;"><span
					style="background: lavender; font-size: 22pt;">활동량:</span> <select
					style="width: 120px; height: 30px; font-size: 13pt;">
						<option value="다시" name="active" selected="selected">활동량
							선택</option>
			...
			<tr>
				<th style="text-align: center; font-size: 20pt;" colspan="2"><span
					style="background: lavender; font-size: 20pt;">Mode:</span> &nbsp;
					<input id="mode" type="radio" checked="checked" name="mode"
					value="health" /> 건강한 삶 <input id="mode" type="radio" name="mode"
					value="diet" /> 목표 달성!</th>
			</tr>
			<tr>
		...
		<table width="400px" height="500px" style="margin-right: 20%; margin-top: 50px;"  border="0" cellpadding="1px" cellspacing="1px">
			<tr>
				<th style="text-align: center; font-size: 22pt;""><span
					style="background: #fafcd9; font-size: 25pt;">★하루 권장 영양소★</span></th>
			</tr>
			<tr>
				<th style="text-align: center; font-size: 22pt;"><span
					style="background: lavender; font-size: 22pt;">칼로리:</span> &nbsp; <input
					type="text" id="kcal" disabled="disabled"
					style="width: 70px; height: 25px; border: 0; text-align: center; font-size: 22pt; color: black;" />
					&nbsp;kcal</th>
			</tr>
			<tr>
				<th style="text-align: center; font-size: 22pt;"><span
					style="background: lavender; font-size: 22pt;">탄수화물:</span> &nbsp;
			...
			<tr>
				<th style="text-align: center; font-size: 22pt;"><span
					style="background: lavender; font-size: 22pt;">단백질:</span> &nbsp; <input
					type="text" id="protein" disabled="disabled"
					style="width: 70px; height: 25px;  border: 0; text-align: center; font-size: 22pt; color: black;" />
					&nbsp;g</th>
			</tr>
			<tr>
				<th style="text-align: center; font-size: 22pt;"><span
					style="background: lavender; font-size: 22pt;">지방:</span> &nbsp; <input
					type="text" id="fat" disabled="disabled"
					style="width: 70px; height: 25px;  border: 0; text-align: center; font-size: 22pt; color: black;" />
					&nbsp;g</th>
			</tr>
			<tr>
				<td align="center">
					<button type="button" onclick="location.reload()"
						style="background: none; border: 0; cursor: pointer; padding-top: 10px;">
						<span
							style="background: #baffda; font-size: 25pt; font-weight: 800;">다시하기</span>
					</button>
				</td>
			</tr>
		</table>

...
//	네이버 로그인 API 등록시 발급받은 Client ID, Client Secret과 Callback URL을 입력한다.
	private final static String CLIENT_ID = "eniNZfHaEPb3Nm2fDDoy";
	private final static String CLIENT_SECRET = "ymZR1W659F";
	private final static String REDIRECT_URI = "http://localhost:8080/foodary/callback";
...
//	네이버 아이디로 인증 URL 생성 Method
	public String getAuthorizationUrl(HttpSession session) {
		System.out.println("getAuthorizationUrl() 실행");
